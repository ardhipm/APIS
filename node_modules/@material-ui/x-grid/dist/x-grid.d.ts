...
interface GridCoreApi extends GridEventEmitter {
     ...
     */
    subscribeEvent: (event: string, handler: (params: any, event: MuiEvent<React$1.SyntheticEvent | DocumentEventMap[keyof DocumentEventMap] | {}>, details: any) => void, options?: GridSubscribeEventOptions) => () => void;
    /**
     * Emits an event.
...
interface GridEditRowApi {
     ...
     */
    commitCellChange: (params: GridCommitCellChangeParams, event?: MouseEvent | React$1.SyntheticEvent) => boolean;
}
 ...
 * The full grid API.
 */
interface GridApi extends GridCoreApi, GridComponentsApi, GridStateApi, GridDensityApi, GridEventsApi, GridRowApi, GridEditRowApi, GridParamsApi, GridColumnApi, GridSelectionApi, GridSortApi, GridVirtualizationApi, GridPageApi, GridPageSizeApi, GridCsvExportApi, GridFocusApi, GridFilterApi, GridColumnMenuApi, GridPreferencesPanelApi, GridLocaleTextApi, GridControlStateApi, GridClipboardApi {
}
...
declare function GridEditSingleSelectCell(props: GridCellParams & SelectProps): JSX.Element;
 ...
 */
declare const useGridColumnReorder: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'disableColumnReorder'>) => void;
...
declare function useGridColumns(apiRef: GridApiRef, props: Pick<GridComponentProps, 'columns' | 'onColumnVisibilityChange' | 'columnTypes' | 'checkboxSelection'>): void;
...
declare const useGridFilter: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'rows' | 'filterModel' | 'onFilterModelChange' | 'filterMode' | 'disableMultipleColumnsFiltering'>) => void;
...
declare function useGridEditRows(apiRef: GridApiRef, props: Pick<GridComponentProps, 'editRowsModel' | 'onEditRowsModelChange' | 'onCellEditCommit' | 'onEditCellPropsChange' | 'onCellEditStart' | 'onCellEditStop' | 'isCellEditable'>): void;
...
declare const useGridSorting: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'rows' | 'sortModel' | 'onSortModelChange' | 'sortingOrder' | 'sortingMode' | 'disableMultipleColumnsSorting'>) => void;
...
declare const useGridComponents: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'components' | 'componentsProps'>) => void;
...
declare function useLoggerFactory(apiRef: any, props: Pick<GridComponentProps, 'logger' | 'logLevel'>): void;
...
declare type XGridProps = Omit<GridComponentProps, 'signature'>;
